function output=PEP_rd(LB,UB,userPrefs)
...
%% NESTED: Computes the distrbution value
    ...
    %   Returns the value of the distribution
     ...
     if nargin==1
        plot3(s(1),s(2),val+0.001,'Marker','o','MarkerSize',9,'MarkerFaceColor','r','MarkerEdgeColor','r');
        drawnow;
...
%% NESTED Write PEP's
    ...
    if ~SHash.containsKey(key(state))
        ...
        plot3(state(1),state(2),...
            Prefs.jointDistribution(state,Prefs.parameters)+0.01,...
